...
bg = pygame.image.load(r"C:\Users\kana_\Desktop\spring 2024\Programming Principles 2\tsis7\images\mic.png").convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load(r"C:\Users\kana_\Desktop\spring 2024\Programming Principles 2\tsis7\images\second.png")
left_rect = image_left.get_rect(bottomleft=(415, 565))
image_right = pygame.image.load(r"C:\Users\kana_\Desktop\spring 2024\Programming Principles 2\tsis7\images\minute.png")
